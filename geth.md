...
NAME    : geth - the go-naxion command line interface
USAGE   : geth [options] command [command options] [arguments...]
VERSION : 2.0.0.2-Naxion-e1fbda06
...
# Geth OPTIONS:
    ...
    --datadir "/home/jasonoh/.Naxion"    Data directory for the databases and keystore
    ...
    --lightserv value                    Maximum percentage of time allowed for serving LES requests (multi-threaded processing allows values 
                                         over 100) (default: 0)
...
# API AND CONSOLE OPTIONS:
    ...
    --rpc.gascap value     Sets a cap on gas that can be used in eth\_call/estimateGas (default: 0)
    ...
    --rpcvhosts value      Comma separated list of virtual hostnames from which to accept requests (server enforced). Accepts '\*' \
...
# MISC OPTIONS:
    ...
    --graphql.rpcvhosts value        Comma separated list of virtual hostnames from which to accept requests (server enforced). Accepts '\*' 
                                     wildcard. (default: "localhost")
    --help, -h                       show help
