...
// Service implements an Naxion netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server      // Peer-to-peer server to retrieve networking infos
	eth    *eth.Naxion      // Full Naxion service if monitoring a full node
	les    *les.LightNaxion // Light Naxion service if monitoring a light node
...
func New(url string, ethServ *eth.Naxion, lesServ *les.LightNaxion) (*Service, error) {
