...
// all blocks' seal as valid, though they still have to conform to the Naxion
// consensus rules.
...
// still have to conform to the Naxion consensus rules.
...
// they still have to conform to the Naxion consensus rules.
