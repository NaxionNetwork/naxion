...
// mapped from textual names used in the tests below to actual Naxion private
...
// address retrieves the Naxion address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Naxion address
