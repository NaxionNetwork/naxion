...
// setting up a new or managing an existing Naxion private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Naxion private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Naxion network down to  |")
	...
	log.Info("Administering Naxion network", "name", w.network)
