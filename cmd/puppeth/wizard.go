...
type wizard struct {
	...
	services map[string][]string   // Naxion services known to be running on servers
...
// converts it to an Naxion address. If an empty line is entered, the default
// value is returned.
