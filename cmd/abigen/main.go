...
var (
	abiFlag = flag.String("abi", "", "Path to the Naxion contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Naxion contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Naxion contract Solidity source to build and bind")
	solcFlag = flag.String("solc", "solc", "Solidity compiler to use if source builds are requested")
	excFlag  = flag.String("exc", "", "Comma separated types to exclude from binding")

	vyFlag    = flag.String("vy", "", "Path to the Naxion contract Vyper source to build and bind")
