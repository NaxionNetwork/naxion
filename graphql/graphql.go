...
// Package graphql provides a GraphQL interface to Naxion node data.
package graphql
...
// Account represents an Naxion account at a particular block.
type Account struct {
...
// Transaction represents an Naxion transaction.
...
// Block represents an Naxion block.
...
type CallData struct {
	From     *common.Address // The Naxion address the call is from.
	To       *common.Address // The Naxion address the call is to.
