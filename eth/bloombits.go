...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Naxion
...
func (eth *Naxion) startBloomHandlers(sectionSize uint64) {
...
// for the Naxion header bloom filters, permitting blazing fast filtering.
